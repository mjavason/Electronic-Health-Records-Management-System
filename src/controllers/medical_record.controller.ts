...
class Controller {
  ...
  async getAll(req: Request, res: Response) {
    ...
    const data = await medicalRecordService.getAll(pagination);
  ...
  async getCount(req: Request, res: Response) {
    const data = await medicalRecordService.getCount(req.query);
  ...
  async find(req: Request, res: Response) {
    ...
    const data = await medicalRecordService.find(req.query);
  ...
  async update(req: Request, res: Response) {
    const { id } = req.params;
    const data = await medicalRecordService.update({ _id: id }, req.body);
  ...
  async delete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await medicalRecordService.softDelete({ _id: id });
  ...
  async hardDelete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await medicalRecordService.hardDelete({ _id: id });
...
export const medicalRecordController = new Controller();
